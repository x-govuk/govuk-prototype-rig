 ...
 *
 * This can be useful for including page titles in URLS or fragment identifers.
 *
 * @example
 *
 *   {{ "Department for Education" | kebab }}
 *
 ...
 * @example
 *
 *   {{ "Department for Business, Energy & Industrial Strategy" | preventorphans }}
 *
...
export function preventorphans (string) {
  ...
  return nunjucksUtils.safe(this.ctx, `${begin}&nbsp;${end}`)
}
